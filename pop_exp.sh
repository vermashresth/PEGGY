...
do
 ...
 do
   python -m egg.zoo.population_signal_game.train --root=data_prep/my_imagenet_features --game_size 3 --vocab_size 5 --n_epochs 200 --lr 1e-3 --max_len 5 --seed $seed --pop_mode 0 --pop_size $pop_size --multi_head 0 --exp_prefix noadv-task-1
  ((seed++))
 done
 ((pop_mode++))
done
